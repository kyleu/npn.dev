...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(f,d){var c=$jscomp.checkStringArgs(this,f,"startsWith");f+="";var a=c.length,e=f.length;d=Math.max(0,Math.min(d|0,c.length));for(var g=0;g<e&&d<a;)if(c[d++]!=f[g++])return!1;return g>=e}},"es6","es3");
$jscomp.polyfill("String.prototype.endsWith",function(b){return b?b:function(f,d){var c=$jscomp.checkStringArgs(this,f,"endsWith");f+="";void 0===d&&(d=c.length);d=Math.max(0,Math.min(d|0,c.length));for(var a=f.length;0<a&&0<d;)if(c[--d]!=f[--a])return!1;return 0>=a}},"es6","es3");$jscomp.arrayIteratorImpl=function(b){var f=0;return function(){return f<b.length?{done:!1,value:b[f++]}:{done:!0}}};$jscomp.arrayIterator=function(b){return{next:$jscomp.arrayIteratorImpl(b)}};$jscomp.initSymbol=function(){};
...
(function(b){b.setPanels=function(f,d,c,a){dom.setDisplay("#welcome-panel",void 0===f);dom.setDisplay("#collection-panel",void 0!==f&&0<f.length&&void 0===d);dom.setDisplay("#request-panel",void 0!==d&&0<d.length);b.setBreadcrumbs(f,d,c,a);a="";c&&(a+=c+" ");f&&(a+=f);d&&(a+="/"+d);a=0==a.length?"npn":"npn: "+a;document.title=a}})(ui||(ui={}));
