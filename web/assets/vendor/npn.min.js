...
function(n){if(n instanceof e)return n;Object.isExtensible(n)&&a(n);return m(n)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(d&&$jscomp.ES6_CONFORMANCE)return d}else if(c())return d;var g="$jscomp_hidden_"+Math.random();f("freeze");f("preventExtensions");f("seal");var k=0,h=function(l){this.id_=(k+=Math.random()+1).toString();if(l){l=$jscomp.makeIterator(l);for(var m;!(m=l.next()).done;)m=m.value,this.set(m[0],m[1])}};h.prototype.set=function(l,m){if(!b(l))throw Error("Invalid WeakMap key");
a(l);if(!$jscomp.owns(l,g))throw Error("WeakMap key fail: "+l);l[g][this.id_]=m;return this};h.prototype.get=function(l){return b(l)&&$jscomp.owns(l,g)?l[g][this.id_]:void 0};h.prototype.has=function(l){return b(l)&&$jscomp.owns(l,g)&&$jscomp.owns(l[g],this.id_)};h.prototype.delete=function(l){return b(l)&&$jscomp.owns(l,g)&&$jscomp.owns(l[g],this.id_)?delete l[g][this.id_]:!1};return h},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(d){function c(){if($jscomp.ASSUME_NO_NATIVE_MAP||!d||"function"!=typeof d||!d.prototype.entries||"function"!=typeof Object.seal)return!1;try{var h=Object.seal({x:4}),l=new d($jscomp.makeIterator([[h,"s"]]));if("s"!=l.get(h)||1!=l.size||l.get({x:4})||l.set({x:4},"t")!=l||2!=l.size)return!1;var m=l.entries(),n=m.next();if(n.done||n.value[0]!=h||"s"!=n.value[1])return!1;n=m.next();return n.done||4!=n.value[0].x||"t"!=n.value[1]||!m.next().done?!1:!0}catch(q){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(d&&$jscomp.ES6_CONFORMANCE)return d}else if(c())return d;var e=new WeakMap,b=function(h){this.data_={};this.head_=g();this.size=0;if(h){h=$jscomp.makeIterator(h);for(var l;!(l=h.next()).done;)l=l.value,this.set(l[0],l[1])}};b.prototype.set=function(h,l){h=0===h?0:h;var m=a(this,h);m.list||(m.list=this.data_[m.id]=[]);m.entry?m.entry.value=l:(m.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:h,value:l},m.list.push(m.entry),
this.head_.previous.next=m.entry,this.head_.previous=m.entry,this.size++);return this};b.prototype.delete=function(h){h=a(this,h);return h.entry&&h.list?(h.list.splice(h.index,1),h.list.length||delete this.data_[h.id],h.entry.previous.next=h.entry.next,h.entry.next.previous=h.entry.previous,h.entry.head=null,this.size--,!0):!1};b.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=g();this.size=0};b.prototype.has=function(h){return!!a(this,h).entry};b.prototype.get=function(h){return(h=
a(this,h).entry)&&h.value};b.prototype.entries=function(){return f(this,function(h){return[h.key,h.value]})};b.prototype.keys=function(){return f(this,function(h){return h.key})};b.prototype.values=function(){return f(this,function(h){return h.value})};b.prototype.forEach=function(h,l){for(var m=this.entries(),n;!(n=m.next()).done;)n=n.value,h.call(l,n[1],n[0],this)};b.prototype[Symbol.iterator]=b.prototype.entries;var a=function(h,l){var m=l&&typeof l;"object"==m||"function"==m?e.has(l)?m=e.get(l):
...
(function(d){function c(g,k){var h=[];(k?k.querySelectorAll(g):document.querySelectorAll(g)).forEach(function(l){h.push(l)});return h}function e(g,k){k=c(g,k);switch(k.length){case 0:break;case 1:return k[0];default:console.warn("found ["+k.length+"] elements with selector ["+g+"], wanted zero or one")}}function b(g,k){(k=e(g,k))||console.warn("no element found for selector ["+g+"]");return k}function a(g,k){"string"===typeof g&&(g=b(g));g.innerHTML=k;return g}function f(g,k,h){h=void 0===h?"block":
h;"string"===typeof g&&(g=b(g));g.style.display=k?h:"none";return g}d.initDom=function(g,k){try{style.themeLinks(k),style.setTheme(g)}catch(h){console.warn("error setting style",h)}try{modal.wire()}catch(h){console.warn("error wiring modals",h)}try{drop.wire()}catch(h){console.warn("error wiring drops",h)}try{tags.wire()}catch(h){console.warn("error wiring tag editors",h)}};d.els=c;d.opt=e;d.req=b;d.setHTML=a;d.setDisplay=f;d.setContent=function(g,k){"string"===typeof g&&(g=b(g));d.clear(g);g.appendChild(k);
return g};d.setText=function(g,k){"string"===typeof g&&(g=b(g));g.innerText=k;return g};d.switchElements=function(g,k){f(g,!1);f(k,!0);return!1};d.clear=function(g){return a(g,"")}})(dom||(dom={}));
...
f),h=new EmojiButton(a);h.on("emoji",function(l){drop.onEmojiPicked();dom.insertAtCaret(k,l)});h.togglePicker(g)},!1)})}}d.setTheme=c;d.linkColor="";d.themeLinks=function(b){d.linkColor=b+"-fg";dom.els(".theme").forEach(function(a){a.classList.add(d.linkColor)})}})(style||(style={}));var drop;
(function(d){function c(f){if(f.target){var g=f.target;f=g.dataset.key||"";g=g.dataset.t||"";var k=events.getOpenEvent(f);k?k(g):console.warn("no drop open handler registered for ["+f+"]")}}function e(f){if(f.target){var g=f.target;g.classList.contains("uk-open")&&(f=g.dataset.t||"",(g=events.getCloseEvent(g.dataset.key||""))&&g(f))}}function b(f){a&&f.preventDefault()}d.wire=function(){dom.els(".drop").forEach(function(f){f.addEventListener("show",c);f.addEventListener("beforehide",b);f.addEventListener("hide",
...
(e=e.substr(1));return{method:"get",protocol:a,domain:f,port:g,path:k,query:c,fragment:e,auth:b}}})(request||(request={}));
(function(d){function c(e){var b=[],a=function(k,h){b.push({t:k,v:h})};a("protocol",e.protocol);a("","://");if(e.auth)for(var f=$jscomp.makeIterator(e.auth),g=f.next();!g.done;g=f.next())if(g=g.value,"basic"===g.type){f=g.config;a("username",f.username);a("",":");f.showPassword?a("password",f.password):a("password","****");a("","@");break}a("domain",e.domain);e.port&&(a("",":"),a("port",e.port.toString()));e.path&&0<e.path.length&&(a("","/"),a("path",e.path));e.query&&0<e.query.length&&(a("","?"),
f=e.query.map(function(k){return encodeURIComponent(k.k)+"="+encodeURIComponent(k.v)}).join("&"),a("query",f));e.fragment&&0<e.fragment.length&&(a("","#"),a("fragment",encodeURIComponent(e.fragment)));return b}d.prototypeToURLParts=c;d.prototypeToURL=function(e){return c(e).map(function(b){return b.v}).join("")}})(request||(request={}));
(function(d){(function(c){c.initAuthEditor=function(e){};c.setAuth=function(e,b){var a=new URL(e.url.value),f="",g="";if(b){b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;k=b.next())k=k.value,"basic"===k.type&&(g=k.config,f=encodeURIComponent(g.username),g=encodeURIComponent(g.password))}a.username=f;a.password=g;e.url.value=a.toString()};c.updateBasicAuth=function(e,b){var a=[];try{a=JSON.parse(e.auth.value)}catch(l){console.log("invalid auth JSON ["+e.auth.value+"]")}var f=-1;a||(a=[]);for(var g=
0;g<a.length;g++)"basic"===a[g].type&&(f=g);if(b)for(g=0;g<b.length;g++){var k=b[g];if("basic"===k.type)var h=k.config}-1===f?h&&a.push({type:"basic",config:h}):h?(b=(b=a[f].config)?{username:h.username,password:h.password,showPassword:b.showPassword}:h,a[f]={type:"basic",config:b}):a.splice(f,1);e.auth.value=JSON.stringify(a,null,2)}})(d.editor||(d.editor={}))})(request||(request={}));
...
(function(d){(function(c){function e(b){var a=JSX("ul",{id:b.id+"-ul",class:"uk-list uk-list-divider"}),f=JSX("li",null,JSX("div",{"data-uk-grid":""},JSX("div",{class:"uk-width-1-4"},"Name"),JSX("div",{class:"uk-width-1-4"},"Value"),JSX("div",{class:"uk-width-1-2"},JSX("div",{class:"right"},JSX("a",{class:style.linkColor,href:"",onclick:"request.editor.addChild(dom.req('#"+b.id+"-ul'), {k: '', v: ''});return false;",title:"new header"},JSX("span",{"data-uk-icon":"icon: plus"}))),"Description")));
b=JSON.parse(b.value);a.innerText="";a.appendChild(f);f=$jscomp.makeIterator(b);for(b=f.next();!b.done;b=f.next())b=b.value,a.appendChild(JSX("li",null,JSX("div",{"data-uk-grid":""},JSX("div",{class:"uk-width-1-4"},b.k),JSX("div",{class:"uk-width-1-4"},b.v),JSX("div",{class:"uk-width-1-2"},JSX("div",{class:"right"},JSX("a",{class:style.linkColor,href:"",onclick:"return false;",title:"new header"},JSX("span",{"data-uk-icon":"icon: close"}))),b.desc?b.desc:""))));return a}c.initHeadersEditor=function(b){b.parentElement.appendChild(e(b))};
c.setHeaders=function(b,a){}})(d.editor||(d.editor={}))})(request||(request={}));(function(d){(function(c){c.initOptionsEditor=function(e){}})(d.editor||(d.editor={}))})(request||(request={}));
...
nav.link(b+"/call","Call","uk-button uk-button-default uk-margin-right","",!0),nav.link(b+"/transform","Transform","uk-button uk-button-default uk-margin-right","",!0),nav.link(b+"/edit","Edit","uk-button uk-button-default uk-margin-right","",!0),nav.link(b+"/delete","Delete","uk-button uk-button-default uk-margin-right","if (!confirm('Are you sure you want to delete request ["+a.key+"]?')) { return false; }",!0))),JSX("hr",null),JSX("div",{"data-uk-grid":""},JSX("div",{class:"uk-width-1-4"},"Key"),
...
(function(d){function c(){var p=document.location,r="ws";"https:"===p.protocol&&(r="wss");return r+("://"+p.host+"/s")}function e(p,r){q=p;t=r;v=Date.now();k=new WebSocket(c());k.onopen=a;k.onmessage=function(u){return f(JSON.parse(u.data))};k.onerror=function(u){return npn.onError("socket",u.type)};k.onclose=g}function b(p){h?(console.debug("out",p),p=JSON.stringify(p,null,2),k.send(p)):n.push(p)}function a(){log.info("socket connected");h=!0;l=1;n.forEach(b);n=[]}function f(p){console.debug("in",
p);switch(p.svc){case services.system.key:system.onSystemMessage(p.cmd,p.param);break;case services.collection.key:collection.onCollectionMessage(p.cmd,p.param);break;default:console.warn("unhandled message for service ["+p.svc+"]")}}function g(){function p(){h=!1;var r=Date.now()-v;2E3>r?(l*=2,console.info("socket closed immediately, reconnecting in "+l+" seconds"),setTimeout(function(){e(q,t)},1E3*l)):(log.info("socket closed after ["+r+"ms]"),e(q,t))}m||p()}var k,h=!1,l=0,m=!1,n=[],q="",t="",v;
...
(function(d){function c(a){for(var f=a.childElementCount-1;0<=f;f--){var g=a.children[f];g.classList.contains("dynamic")&&a.removeChild(g)}}function e(){return JSX("span",{class:"uk-navbar-item dynamic",style:"padding: 0 8px;"}," / ")}function b(a,f,g,k){return k?nav.link("/c/"+f+"/"+g+"/"+k,a,"uk-navbar-item uk-logo uk-margin-remove uk-padding-remove dynamic"):g?nav.link("/c/"+f+"/"+g,a,"uk-navbar-item uk-logo uk-margin-remove uk-padding-remove dynamic"):nav.link("/c/"+f,a,"uk-navbar-item uk-logo uk-margin-remove uk-padding-remove dynamic")}
d.setBreadcrumbs=function(a,f,g){var k=dom.req("#breadcrumbs");c(k);a&&(k.appendChild(e()),k.appendChild(b(a,a)));f&&(k.appendChild(e()),k.appendChild(b(f,a,f)));g&&(k.appendChild(e()),k.appendChild(b(g,a,f,g)))};d.reset=c})(ui||(ui={}));
...
(function(d){function c(f,g){if(0===b)console.warn("call `log.init()` before attempting to log");else{var k=Date.now()-b;f=JSX("li",{class:e(f)},JSX("div",{class:"right"},k,"ms"),g);a||(a=dom.req("#log-panel"));a.appendChild(f)}}function e(f){switch(f){case "debug":return"grey-fg";case "info":return"";case "warn":return"yellow-fg";case "error":return"red-fg";default:return""}}var b=0,a;d.init=function(){b=Date.now();c("debug","npn started")};d.info=function(f){c("info",f)};d.l=c})(log||(log={}));
var nav;
(function(d){function c(b){b.startsWith("/")&&(b=b.substr(1));location.pathname!==b&&history.pushState(b,"","/"+b);e(b)}var e=function(b){console.info("default nav handler called: "+b)};d.init=function(b){e=b;window.onpopstate=function(a){b(null===a.state?"":a.state)};c(location.pathname)};d.navigate=c;d.pop=function(){var b=location.pathname.substr(0,location.pathname.lastIndexOf("/"));"/c"===b&&(b="");c(b)};d.link=function(b,a,f,g,k){var h=b;h.startsWith("/")||(h="/"+h);f=f?" "+f.trim():"";g?g.endsWith(";")||
(g+=";"):g="";k||(f=style.linkColor+f);return JSX("a",{class:f,href:h,onclick:g+"nav.navigate('"+b+"', '"+a+"');return false;"},a)}})(nav||(nav={}));var notify;(function(d){d.notify=function(c,e){UIkit.notification(c,{status:e?"success":"danger",pos:"top-right"})};d.confirm=function(c,e){UIkit.modal.confirm(c).then(e)};d.modal=function(c){var e=UIkit.modal(c);e||console.warn("no modal available with key ["+c+"]");return e}})(notify||(notify={}));var services;
