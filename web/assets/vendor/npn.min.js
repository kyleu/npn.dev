...
function(c){c.state?(c=e(c.state),f(c[0],c[1])):f("","")};b(location.pathname+(0<location.hash.length?location.hash:""))};d.navigate=b;d.pop=function(){var a=location.pathname.substr(0,location.pathname.lastIndexOf("/"));"/c"===a&&(a="");b(a)};d.hashLink=function(a,c,g){0===g.indexOf("#")&&(g=g.substr(1));var h="";if(g===a||"body"===a)h+="uk-active";c=JSX("li",{class:h},JSX("a",{href:"#"+a},c));c.onclick=function(){history.replaceState(history.state,"","#"+a)};return c};d.link=function(a){var c=a.path;
str.startsWith(c,"/")||(c="/"+c);a.cls=a.cls?" "+a.cls.trim():"";var g=JSX("span",null);a.icon&&(g=JSX("span",{class:"nav-icon","data-uk-icon":"icon: "+a.icon}));a.onclk?str.endsWith(a.onclk,";")||(a.onclk+=";"):a.onclk="";a.isButton||(a.cls=style.linkColor+a.cls);var h=a.path;a.hash&&0<a.hash.length&&(h+="#"+a.hash);return JSX("a",{class:a.cls,href:c,onclick:a.onclk+"nav.navigate('"+h+"', '"+a.title+"');return false;"},g,a.title)}})(nav||(nav={}));var notify;
