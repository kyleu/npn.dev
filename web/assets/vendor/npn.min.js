...
function(u){c.connected?(c.debug&&console.debug("out",u),u=json.str(u),g.send(u)):k.push(u)}})(socket||(socket={}));var profile;
...
(function(c){c.renderBody=function(d,f){if(!f)return JSX("div",null,"No body");switch(f.type){case "json":return f=Prism.highlight(JSON.stringify(f.config.msg,null,2),Prism.languages.javascript,"javascript"),JSX("div",null,JSX("em",null,"JSON"),JSX("div",{class:"mt"},JSX("pre",{class:"language-html","data-start":"0",style:"white-space:pre-wrap;"},JSX("code",{dangerouslySetInnerHTML:{__html:f}}))));case "html":return d=request.baseURL(d),f=Prism.highlight(f.config.content,Prism.languages.html,"html"),
JSX("div",{class:"html-body"},JSX("span",{class:"base-url hidden"},d),JSX("span",{class:"preview-link right"},"(",JSX("a",{class:style.linkColor,href:"",onclick:"rbody.renderHTMLPreview(this);return false"},"preview"),")"),JSX("span",{class:"text-link right hidden"},"(",JSX("a",{class:style.linkColor,href:"",onclick:"rbody.renderHTMLText(this);return false"},"text"),")"),JSX("em",null,"HTML"),JSX("div",{class:"text-content prism mt",style:"overflow: auto; max-height: 720px;"},JSX("pre",{class:"language-html",
"data-start":"0",style:"white-space:pre-wrap;"},JSX("code",{dangerouslySetInnerHTML:{__html:f}}))),JSX("div",{class:"preview-content mt hidden",style:"overflow: auto; max-height: 720px; border: 1px solid #666;"}));case "image":return f=f.config,JSX("img",{alt:"response image",src:"data:"+f.type+";base64,"+f.content});case "raw":return f=f.config,JSX("div",null,JSX("em",null,f.type?f.type:"Unknown Type"),JSX("pre",null,json.str(f)));case "error":return f=f.config,JSX("div",null,JSX("em",null,"Error"),
JSX("pre",null,f.message));default:return JSX("div",null,"unhandled body type [",f.type,"]")}}})(rbody||(rbody={}));
...
(function(c){(function(d){function f(h,k,l){var m=new URL(h.value),q="",t="";"basic"===(null===l||void 0===l?void 0:l.type)&&(l=l.config,q=encodeURIComponent(l.username),t=encodeURIComponent(l.password));m.username=q;m.password=t;m=m.toString();dom.setValue(h,m);dom.setContent(k,c.prototypeToHTML(c.prototypeFromURL(m)))}function e(h){var k=json.parse(h.value);return JSX("div",{class:"mt"},b(h,k),auth.AllTypes.filter(function(l){return!l.hidden}).map(function(l){var m=k&&k.type==l.key?k.config:null,
q=l.key,t=l.key===(null===k||void 0===k?void 0:k.type);l="mt body-editor";t||(l+=" hidden");switch(q){case "basic":m=a(q,t?m:void 0,h);break;default:m=JSX("div",null,"Unimplemented [",q,"] auth editor")}return JSX("div",{class:l,"data-key":q},m)}))}function b(h,k){var l=JSX("select",{class:"uk-select"},JSX("option",{value:""},"No body"),auth.AllTypes.filter(function(m){return!m.hidden}).map(function(m){return k&&k.type===m.key?JSX("option",{value:m.key,selected:"selected"},m.title):JSX("option",{value:m.key},
m.title)}));d.events(l,function(){dom.els(".body-editor",l.parentElement).forEach(function(m){var q=m.dataset.key;l.value===q?(""===q&&(dom.setValue(h,"null"),d.check()),m.classList.remove("hidden")):m.classList.add("hidden")})});return l}function a(h,k,l){var m=JSX("textarea",{class:"uk-textarea"},json.str(k));d.events(m,function(){var q=m.value;try{q=json.parse(q)}catch(t){}diff.comp("",k,q,function(t,u,w){});g("json",{type:"basic",config:q},l)});return m}function g(h,k,l){h=dom.req("#"+l.id.replace("-auth",
"-url"));var m=dom.req("#"+l.id.replace("-auth","-urlview"));f(h,m,k);dom.setValue(l,json.str(k));d.check()}d.initAuthEditor=function(h){h.parentElement.appendChild(e(h))};d.setAuth=f})(c.editor||(c.editor={}))})(request||(request={}));
(function(c){(function(d){function f(h){var k=json.parse(h.value);return JSX("div",{class:"mt"},e(h,k),JSX("div",{class:"body-editor","data-key":""}),rbody.AllTypes.filter(function(l){return!l.hidden}).map(function(l){var m=l.key,q=k&&k.type==l.key?k.config:null,t=l.key===(k?k.type:"");l="mt body-editor";t||(l+=" hidden");switch(m){case "json":q=a(m,t?q:void 0,h);break;case "html":q=b(m,t?q:void 0,h);break;default:q=JSX("div",null,"Unimplemented [",m,"] body editor")}return JSX("div",{class:l,"data-key":m},
q)}))}function e(h,k){var l=JSX("select",{class:"uk-select"},JSX("option",{value:""},"No body"),rbody.AllTypes.filter(function(m){return!m.hidden}).map(function(m){return k&&k.type===m.key?JSX("option",{value:m.key,selected:"selected"},m.title):JSX("option",{value:m.key},m.title)}));d.events(l,function(){dom.els(".body-editor",l.parentElement).forEach(function(m){var q=m.dataset.key;l.value===q?(""===q&&(dom.setValue(h,"null"),d.check()),m.classList.remove("hidden")):m.classList.add("hidden")})});
...
(function(c){(function(d){function f(n){var r=json.parse(n.value);r||(r={});return JSX("div",null,JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"-timeout"},"Timeout"),a(n,r.timeout)),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label"},"Ignore"),JSX("div",null,g(n,r.ignoreRedirects),h(n,r.ignoreReferrer),k(n,r.ignoreCerts),l(n,r.ignoreCookies))),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"-excludeDefaultHeaders"},"Exclude Default Headers"),m(n,r.excludeDefaultHeaders)),
JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"-readCookieJars"},"Read Cookie Jars"),q(n,r.readCookieJars)),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"writeCookieJar"},"Write Cookie Jar"),t(n,r.writeCookieJar)),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"-sslCert"},"SSL Cert"),u(n,r.sslCert)),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:n.id+"-userAgentOverride"},"User Agent Override"),w(n,r.userAgentOverride)))}
function e(n,r,p,v){n="opt-"+r;return v?JSX("label",{class:"uk-margin-right"},JSX("input",{type:"checkbox",name:n,value:"true",checked:!0})," ",p):JSX("label",{class:"uk-margin-right"},JSX("input",{type:"checkbox",name:n,value:"true"})," ",p)}function b(n,r,p){d.events(n,function(){var v=json.parse(p.value);r(v);dom.setValue(p,json.str(v));d.check()})}function a(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-timeout",name:"opt-timeout",type:"number",value:r||0});b(p,function(v){return v.timeout=
parseInt(p.value,10)},n);return p}function g(n,r){var p=e(n.id,"ignoreRedirects","Redirects",r||!1);b(p,function(v){return v.ignoreRedirects=dom.req("input",p).checked},n);return p}function h(n,r){var p=e(n.id,"ignoreReferrer","Referrer",r||!1);b(p,function(v){return v.ignoreReferrer=dom.req("input",p).checked},n);return p}function k(n,r){var p=e(n.id,"ignoreCerts","Certs",r||!1);b(p,function(v){return v.ignoreCerts=dom.req("input",p).checked},n);return p}function l(n,r){var p=e(n.id,"ignoreCookies",
"Cookies",r||!1);b(p,function(v){return v.ignoreCookies=dom.req("input",p).checked},n);return p}function m(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-excludeDefaultHeaders",name:"opt-excludeDefaultHeaders",type:"text",value:r});b(p,function(v){return v.excludeDefaultHeaders=p.value.split(",").map(function(x){return x.trim()})},n);return p}function q(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-readCookieJars",name:"opt-readCookieJars",type:"text",value:r});b(p,function(v){return v.readCookieJars=
p.value.split(",").map(function(x){return x.trim()})},n);return p}function t(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-writeCookieJar",name:"opt-writeCookieJar",type:"text",value:r});b(p,function(v){return v.writeCookieJar=p.value},n);return p}function u(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-sslCert",name:"opt-sslCert",type:"text",value:r});b(p,function(v){return v.sslCert=p.value},n);return p}function w(n,r){var p=JSX("input",{class:"uk-input",id:n.id+"-userAgentOverride",name:"opt-userAgentOverride",
type:"text",value:r||""});b(p,function(v){return v.userAgentOverride=p.value},n);return p}d.initOptionsEditor=function(n){n.parentElement.appendChild(f(n))}})(c.editor||(c.editor={}))})(request||(request={}));
...
(function(c){(function(d){function f(b,a){var g="/c/"+b+"/"+a.key;b="if (!confirm('Are you sure you want to delete request ["+a.key+"]?')) { return false; }";return JSX("div",null,nav.link({path:g+"/call",title:"Call",cls:"uk-button uk-button-default uk-margin-small-right mt",isButton:!0}),JSX("div",{class:"uk-inline"},JSX("button",{type:"button",class:"uk-button uk-button-default uk-margin-small-right mt"},"Export"),JSX("div",{id:"export-dropdown","uk-dropdown":"mode: click"},JSX("ul",{class:"uk-list uk-list-divider",
style:"margin-bottom: 0;"},Object.keys(e).map(function(h){return JSX("li",null,nav.link({path:g+"/transform/"+h,title:e[h],onclk:"UIkit.dropdown(dom.req('#export-dropdown')).hide(false);"}))})))),nav.link({path:g+"/delete",title:"Delete",cls:"uk-button uk-button-default uk-margin-small-right mt",onclk:b,isButton:!0}))}d.renderFormPanel=function(b,a){var g=JSX("div",{class:"right"},JSX("a",{class:"theme uk-icon","data-uk-icon":"close",href:"",onclick:"nav.navigate('/c/"+b+"');return false;",title:"close request"})),
h=JSX("h3",{class:"uk-card-title"},a.title?a.title:a.key),k=d.renderURL(b,a);var l=JSX("div",{id:"save-panel",class:"right hidden"},JSX("button",{class:"uk-button uk-button-default uk-margin-small-right mt",onclick:"request.form.reset('"+b+"', '"+a.key+"');"},"Reset"),JSX("button",{class:"uk-button uk-button-default mt",onclick:"request.form.saveCurrentRequest('"+b+"', '"+a.key+"');"},"Save Changes"));return JSX("div",null,JSX("div",{class:"uk-card uk-card-body uk-card-default"},g,h,k,l,f(b,a)),JSX("div",
{class:"request-editor uk-card uk-card-body uk-card-default mt"},JSX("form",{action:"",method:"post",onsubmit:"console.log('XXXXXXX');return false;"},d.renderSwitcher(a,location.hash))),JSX("div",{class:"request-action uk-card uk-card-body uk-card-default mt hidden"}))};d.renderDetails=function(b){return JSX("li",{class:"request-details-panel"},JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:b.key+"-key"},"Key"),JSX("input",{class:"uk-input",id:b.key+"-key",name:"key",type:"text",value:b.key||
"","data-lpignore":"true"})),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:b.key+"-title"},"Title"),JSX("input",{class:"uk-input",id:b.key+"-title",name:"title",type:"text",value:b.title||"","data-lpignore":"true"})),JSX("div",{class:"mt"},JSX("label",{class:"uk-form-label",for:b.key+"-description"},"Description"),JSX("textarea",{class:"uk-textarea",id:b.key+"-description",name:"description","data-lpignore":"true"},b.description||"")))};d.reset=function(b,a){c.render(b,a)};var e={http:"HTTP",
json:"JSON",curl:"curl"}})(c.form||(c.form={}))})(request||(request={}));
(function(c){(function(d){d.renderSwitcher=function(f,e){var b=f.key,a=f.prototype;return JSX("div",null,JSX("ul",{"data-uk-tab":""},nav.hashLink("details","Details",e),nav.hashLink("query","Query",e),nav.hashLink("auth","Auth",e),nav.hashLink("headers","Headers",e),nav.hashLink("body","Body",e),nav.hashLink("options","Options",e)),JSX("ul",{class:"uk-switcher uk-margin"},d.renderDetails(f),JSX("li",{class:"request-queryparams-panel"},JSX("div",{class:"mt"},JSX("textarea",{class:"uk-textarea hidden",
id:b+"-queryparams",name:"queryparams"},json.str(a.query)))),JSX("li",{class:"request-auth-panel"},JSX("div",{class:"mt"},JSX("textarea",{class:"uk-textarea hidden",id:b+"-auth",name:"auth"},json.str(a.auth)))),JSX("li",{class:"request-headers-panel"},JSX("div",{class:"mt"},JSX("textarea",{class:"uk-textarea hidden",id:b+"-headers",name:"headers"},json.str(a.headers)))),JSX("li",{class:"request-body-panel"},JSX("div",{class:"mt"},JSX("textarea",{class:"uk-textarea hidden",id:b+"-body",name:"body"},
json.str(a.body)))),JSX("li",{class:"request-options-panel"},JSX("div",{class:"mt"},JSX("textarea",{class:"uk-textarea hidden",id:b+"-options",name:"options"},json.str(a.options))))))}})(c.form||(c.form={}))})(request||(request={}));
(function(c){(function(d){d.renderURL=function(f,e){f="nav.navigate(`/c/"+f+"/"+e.key+"/call`);return false;";var b=c.prototypeToURL(e.prototype);return JSX("div",{class:"mt uk-panel"},JSX("div",{class:"left",style:"width:120px;"},JSX("select",{class:"uk-select",id:e.key+"-method",name:"method"},c.allMethods.map(function(a){return a.key===e.prototype.method?JSX("option",{selected:"selected"},a.key):JSX("option",null,a.key)}))),JSX("div",{class:"url-view uk-inline right",id:e.key+"-link",style:"width:calc(100% - 120px);"},
JSX("a",{class:"uk-form-icon uk-form-icon-flip",href:"",onclick:f,title:"send request","data-uk-icon":"icon: play"}),JSX("div",{onclick:"request.editor.toggleURLEditor('"+e.key+"', true);"},JSX("span",{id:e.key+"-urlview",class:"url-link"},c.prototypeToHTML(e.prototype)))),JSX("div",{class:"url-input hidden uk-inline right",id:e.key+"-edit",style:"width:calc(100% - 120px);"},JSX("a",{class:"uk-form-icon uk-form-icon-flip",href:"",onclick:"request.editor.toggleURLEditor('"+e.key+"', false);return false;",
title:"cancel edit","data-uk-icon":"icon: close"}),JSX("form",{onsubmit:f},JSX("input",{class:"uk-input",id:e.key+"-url",name:"url",type:"text",value:b,"data-lpignore":"true"}))))}})(c.form||(c.form={}))})(request||(request={}));var transform;
(function(c){c.renderRequest=function(d,f,e){return JSX("div",{id:d+"--"+f+"-transform"},request.renderActionClose(),JSX("div",{class:"transform-title"},e),JSX("div",{class:"transform-result"}))};c.setResult=function(d){var f=dom.req("#"+d.coll+"--"+d.req+"-transform .transform-result");dom.setContent(f,JSX("div",{class:"mt"},JSX("pre",null,d.out)));log.info("call result ["+d.coll+"/"+d.req+": "+d.fmt+"] received")}})(transform||(transform={}));var system;
