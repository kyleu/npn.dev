  ...
  export function renderURL(coll: string, r: request.Request) {
    ...
    return <div class="mt uk-panel">
      ...
      <div class="url-view uk-inline right" id={r.key + "-link"} style="width:calc(100% - 120px);">
        <a class="uk-form-icon uk-form-icon-flip" href="" onclick={call} title="send request" data-uk-icon="icon: play" />
      ...
      <div class="url-input hidden uk-inline right" id={r.key + "-edit"} style="width:calc(100% - 120px);">
        <a class="uk-form-icon uk-form-icon-flip" href="" onclick={"request.editor.toggleURLEditor('" + r.key + "', false);return false;"} title="cancel edit" data-uk-icon="icon: close" />
        <form onsubmit={call}>
