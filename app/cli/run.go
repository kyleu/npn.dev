...
func setIcon() {
	...
	if public {
		npnweb.NavbarContent = func(color string) string {
			return `
	<li class="header-optional"><a class="nav-f" href="/">About</a></li>
	<li class="header-optional"><a class="nav-f" href="https://github.com/kyleu/npn">GitHub</a></li>
	<li class="header-optional"><a class="nav-f" href="/download"><div class="download-link">Download</div></a></li>`
		}
	}
}
