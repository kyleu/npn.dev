...
require (
	...
	github.com/kyleu/npn/npnconnection v0.0.20 // npn
	github.com/kyleu/npn/npncontroller v0.0.20 // npn
	github.com/kyleu/npn/npncore v0.0.20 // npn
	github.com/kyleu/npn/npnservice v0.0.20 // npn
	github.com/kyleu/npn/npnservice-fs v0.0.20 // npn
	github.com/kyleu/npn/npntemplate v0.0.20 // npn
	github.com/kyleu/npn/npnuser v0.0.20 // npn
	github.com/kyleu/npn/npnweb v0.0.20 // npn
