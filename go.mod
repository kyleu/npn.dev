...
require (
	...
	github.com/kyleu/npn/npnasset v0.0.12 // npn
	...
	github.com/kyleu/npn/npnservice v0.0.12 // npn
	github.com/kyleu/npn/npnservice-fs v0.0.12 // npn
	github.com/kyleu/npn/npntemplate v0.0.12 // npn
