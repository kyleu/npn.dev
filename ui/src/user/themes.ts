...
const Kayak = { key: "Kayak", mode: "light", navB: "#5d917d", navF: "#825534", menuB: "#a8ad80", menuF: "#e6d4a7", menuL: "#825534", bodyB: "#36362c", bodyL: "#825534" };
...
export const allThemes: ThemeColors[] = [
  ...
  WomanInPurpleDress,
  XDustyPetrol,
  ZenAndTea, KnotJustNautical, MountainsOfBurma, Optimist, LifeIsBeautiful, Bogart, Campfire, Lollapalooza, Kayak, SunshineOverGlacier, Harbor, HerbsAndSpice
];
